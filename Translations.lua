Config.Languages = {
    ...
    ['da'] = { -- Danish 🇩🇰
        ...
        ['newsetemote'] = "~w~ er nu din favorit animation, tryk ~g~Caps Lock~w~ for at bruge den.",
        ['cancelemote'] = "Afbryd animation",
        ['cancelemoteinfo'] = "~r~X~w~ annullerer din igangværende animation.",
        ['walkingstyles'] = "Gåstile",
        ...
        ['emotemenucmd'] = "Skriv /emotemenu for animations menuen",
        ...
        ['bound'] = "Bundet ",
        ['to'] = "til",
        ['currentlyboundemotes'] = " Keybinds animationer:",
